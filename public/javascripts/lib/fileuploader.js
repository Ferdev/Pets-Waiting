...
qq.FileUploader = function(o){
    this._options = {
        ...
        template: '<div class="qq-uploader">' + 
                '<div class="qq-upload-drop-area"><span>{DROP_TEXT}</span></div>' +
        ...
        fileTemplate: '<li>' +
                ...
                '<a class="qq-upload-cancel" href="#">{CANCEL_TEXT}</a>' +
                '<span class="qq-upload-failed-text">{FAILED_TEXT}</span>' +
            '</li>',
    ...
    this._options.template = this._options.template.replace('{DROP_TEXT}', this._options.translations.template.drop);
    this._options.template = this._options.template.replace('{BUTTON_TEXT}', this._options.translations.template.button);
    this._element.innerHTML = this._options.template;
    
    this._options.fileTemplate = this._options.fileTemplate.replace('{CANCEL_TEXT}', this._options.translations.file_template.cancel);
    this._options.fileTemplate = this._options.fileTemplate.replace('{FAILED_TEXT}', this._options.translations.file_template.failed);
